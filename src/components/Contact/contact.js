   ...
   return(
     ...
     <form className="contact-form" onSubmit={this.handleSubmit.bind(this)}>
      ...
      <div className="form-group">
          ...
          <textarea className="form-control" placeholder="Please type your message here if you have a job for me, a million dollar to give me, if you just want to say hi or report a bug" rows="5" value={this.state.message} name="message" onChange={this.onMessageChange.bind(this)} />
      </div>
